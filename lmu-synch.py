...
# -*- coding: utf-8 -*-
'''
This script fetches the video names and urls from an LMU-Cast website,
generates corresponding filenames and downloads the videos to the directory
which contains this script (unless these filenames already exist in there).
